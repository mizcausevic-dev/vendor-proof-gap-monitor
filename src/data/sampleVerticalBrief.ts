...
export const sampleVendorProofGapMonitor: ProofGapItem[] = [
  {
    "id": "kg-suite-proof-pack",
    "owner": "Miz Causevic (solo founder)",
    "audience": "Board diligence reviewer · vendor evaluator · investor",
    "sector": "AI_PLATFORM",
    "proofStage": "READY_TO_REUSE",
    "proofState": "REUSABLE",
    "proofTheme": "Open JSON specs + canonical hashing + ed25519 signing for the AI procurement era",
    ...
    "currentProofPack": "Eleven open specs published; hash-attestation-rs ships ed25519 signing; audit-stream-py + audit-stream-prometheus feed the same canonical hash chain; 9 of 11 specs have spec landings; all aligned with NIST AI RMF crosswalk.",
    ...
    "claimCoverageScore": 92,
    "proofFreshnessScore": 91,
    "evidenceDepthScore": 89,
    "benchmarkConfidenceScore": 78,
    "reuseSafetyScore": 92,
    "reviewCycleDays": 2,
  ...
  {
    "id": "ai-procurement-pulse-proof-pack",
    "owner": "Miz Causevic (solo founder)",
    "audience": "Board diligence reviewer · vendor evaluator · investor",
    "sector": "AI_PLATFORM",
    "proofStage": "READY_TO_REUSE",
    "proofState": "REUSABLE",
    "proofTheme": "Quarterly ed25519-signed crawl of 1,457 domains across 38 verticals scoring AI-procurement disclosure depth",
    "operatingQuestion": "Can we hand a buyer a public, signed measurement of the industry instead of self-report claims?",
    "currentProofPack": "4 published Issues; signing-key indexed at /.well-known/pulse-signing.json; universe.csv at 1,457 domains; scheduled quarterly Action committed for Aug/Nov/Feb/May 15; summarizer auto-drafts Issue body.",
    "headlineGap": "Per-vertical sub-issues would compound buyer signal — currently a single combined report per quarter.",
    "claimCoverageScore": 95,
    "proofFreshnessScore": 93,
    "evidenceDepthScore": 88,
  ...
  {
    "id": "operator-diagnostics-proof-pack",
    "owner": "Miz Causevic (solo founder)",
    "audience": "Board diligence reviewer · vendor evaluator · investor",
    "sector": "REVENUE_SYSTEMS",
    "proofStage": "READY_TO_REUSE",
    "proofState": "REUSABLE",
    "proofTheme": "Four operator surfaces distinct from /trust/ governance and /calculators/ rubric math",
    "operatingQuestion": "Can a CFO or CRO open one of these surfaces and answer their operator question without a custom build?",
    "currentProofPack": "4 surfaces shipped to v1.0-prod 2026-05-31 (reality, revenue, replace, members); each is a Style01 dark-themed dashboard with synthetic operator data.",
    ...
    "claimCoverageScore": 84,
    "proofFreshnessScore": 90,
    "evidenceDepthScore": 78,
    "benchmarkConfidenceScore": 72,
    "reuseSafetyScore": 82,
    "reviewCycleDays": 4,
  ...
  {
    "id": "healthtech-clinical-proof-pack",
    "owner": "Miz Causevic (solo founder)",
    "audience": "Board diligence reviewer · vendor evaluator · investor",
    "sector": "HEALTHTECH",
    "proofStage": "READY_TO_REUSE",
    "proofState": "REUSABLE",
    "proofTheme": "Eight clinical / GxP-territory operator surfaces with explicit 'no compliance claim' discipline",
    ...
    "currentProofPack": "8 surfaces shipped (gxp/assay/capa/narrative/diagnostics/instruments/safety/specimen); language audit returned clean; each carries explicit 'no claim of HIPAA / GMP / GxP / FDA compliance' disclaimer.",
    "headlineGap": "No HealthTech buyer in the pipeline yet — surfaces are show-don't-tell evidence rather than active sales tools.",
    "claimCoverageScore": 87,
    "proofFreshnessScore": 89,
    "evidenceDepthScore": 86,
    "benchmarkConfidenceScore": 76,
    "reuseSafetyScore": 84,
    "reviewCycleDays": 5,
  ...
  {
    "id": "growth-consent-ops-proof-pack",
    "owner": "Miz Causevic (solo founder)",
    "audience": "Board diligence reviewer · vendor evaluator · investor",
    "sector": "REVENUE_SYSTEMS",
    "proofStage": "REVIEWING",
    "proofState": "AT_RISK",
    "proofTheme": "Marketing, consent, and attribution governance — 4 named tracks at growth.kineticgain.com",
    ...
    "currentProofPack": "Growth Ops hub live with 4 tracks; klaviyo-flow-consent-audit + vwo-experiment-governance-mirror + martech-experiment-evidence-stack + identity-lifecycle-workbench + Skyflow-Klaviyo bridge + UTM attribution Go lib all shipped.",
    ...
    "claimCoverageScore": 82,
    "proofFreshnessScore": 85,
    "evidenceDepthScore": 79,
    "benchmarkConfidenceScore": 74,
    "reuseSafetyScore": 80,
    "reviewCycleDays": 5,
  ...
  {
    "id": "trust-pack-proof-pack",
    "owner": "Miz Causevic (solo founder)",
    "audience": "Board diligence reviewer · vendor evaluator · investor",
    "sector": "AI_PLATFORM",
    "proofStage": "READY_TO_REUSE",
    "proofState": "REUSABLE",
    "proofTheme": "Eight browser-only AI diligence tools at the apex /trust/ pillar — no backend, no login, no telemetry",
    ...
    "currentProofPack": "8 Trust Pack tools live at kineticgain.com/trust/ (AI System Card, Evidence Locker, Shadow AI Discovery, AI Vendor Intake, AI Tabletop, Risk Register, Subprocessors, Vendor AI Disclosure Review); all vanilla JS + inline CSS + under 30KB.",
    "headlineGap": "Per-tool usage analytics not present — choosing which to deepen next is currently guesswork.",
    "claimCoverageScore": 91,
    "proofFreshnessScore": 88,
    "evidenceDepthScore": 87,
    "benchmarkConfidenceScore": 80,
    "reuseSafetyScore": 93,
    "reviewCycleDays": 2,
  ...
  {
    "id": "sales-enablement-stack-proof-pack",
    "owner": "Miz Causevic (solo founder)",
    "audience": "Board diligence reviewer · vendor evaluator · investor",
    "sector": "REVENUE_SYSTEMS",
    "proofStage": "REVIEWING",
    "proofState": "NEEDS_REFRESH",
    "proofTheme": "Four seller-side operator surfaces — proof-gap monitor, trust-center evidence room, security-questionnaire answer studio, RFP response assembler",
    ...
    "currentProofPack": "4 surfaces shipped + hardened to v1.0-prod 2026-05-31; SSL provisioning on subdomain HTTPS (HTTP confirms live); THIS fixture is the dogfood (you are looking at it).",
    "headlineGap": "Subdomain SSL first-time-provisioning lag (auto-resolves in 24h); per-surface analytics not yet wired.",
    "claimCoverageScore": 78,
    "proofFreshnessScore": 95,
    "evidenceDepthScore": 76,
    "benchmarkConfidenceScore": 70,
    "reuseSafetyScore": 82,
    "reviewCycleDays": 1,
  ...
  {
    "id": "kinetic-gain-embedded-proof-pack",
    "owner": "Miz Causevic (solo founder)",
    "audience": "Board diligence reviewer · vendor evaluator · investor",
    "sector": "AI_PLATFORM",
    "proofStage": "REVIEWING",
    "proofState": "AT_RISK",
    "proofTheme": "Drop-in audit-stream + Decision Card vault contract SDK for B2B SaaS embedders",
    ...
    "currentProofPack": "Phase 1 SDK shipped at v0.1.1; TypeScript dual ESM/CJS; zero runtime deps; Procurement Packet Starter shipped in docs/sales/; npm-publish workflow wired but blocked on NPM_TOKEN.",
    ...
    "claimCoverageScore": 76,
    "proofFreshnessScore": 90,
    "evidenceDepthScore": 84,
    "benchmarkConfidenceScore": 68,
    "reuseSafetyScore": 72,
    "reviewCycleDays": 7,
